...
const projects: Project[] = [
  {
    ...
    media: [
      "/projects/elastisitas/1..png",
      "/projects/elastisitas/2..png",
      "/projects/elastisitas/3..png",
      "/projects/elastisitas/4..png",
      "/projects/elastisitas/5.png",
  ...
  },
  {
    ...
    details: {
      id: "Menganalisis 21.567+ transaksi pembelian untuk menemukan pola keterkaitan antarproduk dan memahami perilaku pembelian pelanggan. Data diproses melalui tahap preprocessing sebelum dilakukan Association Rule Mining menggunakan metrik support, confidence, dan lift untuk menemukan kombinasi produk yang sering dibeli bersama.\n\nAnalisis juga dilengkapi dengan time-based feature engineering untuk melihat pola pembelian berdasarkan waktu. Dari hasil analisis, diperoleh 9 rekomendasi promotional bundle dan 12 rekomendasi bonus item yang dapat digunakan sebagai referensi dalam penyusunan strategi promosi.\n\nHasil analisis kemudian diterjemahkan menjadi rekomendasi bisnis yang lebih mudah digunakan untuk membantu memahami pola pembelian dan peluang promosi berbasis data.",
      en: "Analyzing 21,567+ purchase transactions to uncover product association patterns and understand customer buying behavior. Data was prepared through a preprocessing stage before applying Association Rule Mining using support, confidence, and lift metrics to identify frequently co-purchased item combinations.\n\nThe analysis also incorporated time-based feature engineering to examine purchasing patterns across different timeframes. From the findings, 9 promotional bundle recommendations and 12 bonus item recommendations were derived to serve as actionable references for promotional strategies.\n\nThe analytical insights were translated into practical business recommendations to facilitate data-driven promotional decision making.",
    },
    media: [
      "/projects/association/1..png",
      "/projects/association/2..png",
      "/projects/association/3..png",
      "/projects/association/4..png",
      "/projects/association/5..png",
      "/projects/association/6..png",
      "/projects/association/7..jpeg",
      "/projects/association/8..png",
    ],
  ...
  },
  {
    num: "03",
    name: {
      id: "Haidar Plastik OS",
      en: "Haidar Plastik OS",
    },
    stack: [
      "React",
      "TypeScript",
    ...
    desc: {
      id: "Progressive Web App untuk mengelola inventory dan operasional toko secara terpusat, dari data produk dan harga hingga inspeksi stok dan analitik bisnis.",
      en: "Progressive Web App to centrally manage store inventory and operations, from product and price data to stock inspections and business analytics.",
    },
    details: {
      id: "Mengembangkan Progressive Web App (PWA) untuk Haidar Plastik, toko retail di Bekasi, untuk memusatkan pengelolaan inventory dan operasional toko sehari-hari.\n\nSistem dirancang untuk mengelola data produk, kategori, satuan, harga jual resmi, stok, serta jadwal inspeksi. Aplikasi juga menerapkan workflow berbasis role untuk Admin dan Staff dengan protected navigation dan permission-based access terhadap data operasional.\n\nMengimplementasikan pengelolaan harga jual resmi dan price history tracking untuk mencatat perubahan harga beserta version history dan status perubahan. Dikembangkan pula workflow physical stock inspection untuk staff, termasuk jadwal inspeksi, submission locking, dan correction request.\n\nMembangun Admin operational dashboard yang menyajikan inventory analytics dan key business metrics sebagai centralized overview terhadap data toko.\n\nBackend menggunakan Supabase/PostgreSQL dengan Row Level Security (RLS) untuk melindungi data sensitif, termasuk purchase prices agar tidak dapat diakses oleh user non-admin.\n\nMengembangkan responsive mobile-first UI/UX menggunakan React, TypeScript, Vite, Tailwind CSS, Zustand, dan Motion. Aplikasi juga menggunakan PWA dan IndexedDB untuk mendukung kemampuan offline dan local data handling.\n\nPada landing page, dikembangkan interactive experience menggunakan frame-accurate cursor-scrub video animation.\n\nProject ini dikembangkan dan diuji berdasarkan workflow operasional bisnis untuk memastikan aplikasi stabil sebelum deployment.",
      en: "Developing a Progressive Web App (PWA) for Haidar Plastik, a retail store in Bekasi, to centralize inventory and daily store operations management.\n\nThe system is engineered to manage products, categories, units, official retail pricing, stock levels, and inspection schedules. The application implements role-based workflows for Admin and Staff with protected navigation and permission-based access to operational data.\n\nFeatures include official retail price management and price history tracking to log price adjustments along with version history and change statuses. Also developed is a physical stock inspection workflow for staff, complete with inspection schedules, submission locking, and correction requests.\n\nBuilt an Admin operational dashboard providing inventory analytics and key business metrics for a centralized overview of store operations.\n\nThe backend utilizes Supabase/PostgreSQL with Row Level Security (RLS) to protect sensitive data, including purchase prices from non-admin users.\n\nCrafted a responsive mobile-first UI/UX using React, TypeScript, Vite, Tailwind CSS, Zustand, and Motion. The application leverages PWA and IndexedDB to ensure offline resilience and robust local data handling.\n\nOn the landing page, an interactive experience was developed using frame-accurate cursor-scrub video animation.\n\nThis project was designed and validated against real business operational workflows to guarantee stability prior to deployment.",
    },
    url: "https://toko.zzaa.my.id/",
    media: [
      "/projects/haidarOS/1.png",
      "/projects/haidarOS/2.png",
      "/projects/haidarOS/3.png",
      "/projects/haidarOS/4.png",
      "/projects/haidarOS/5.png",
      "/projects/haidarOS/6.png",
      "/projects/haidarOS/7.png",
    ],
    highlights: ["sql", "android"],
    align: "left",
    section: "project3",
  },
  {
