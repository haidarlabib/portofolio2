...
const projects: Project[] = [
  {
    num: "01",
    name: {
      id: "Penjawab Ulasan Google Berbasis AI",
    ...
    desc: {
      id: "SaaS yang menghasilkan balasan personal untuk ulasan Google Business Profile dengan AI, menjaga konsistensi gaya bahasa brand.",
      en: "SaaS that generates personalised replies to Google Business Profile reviews with AI while keeping the brand tone.",
    },
    details: {
      id: "Platform untuk bisnis lokal dalam mengelola ulasan Google Business Profile mereka. Sistem melakukan polling setiap 15 menit, menggunakan Claude untuk membuat draf balasan sesuai gaya bahasa brand dan menerbitkannya secara otomatis (atau mengirimkannya untuk ditinjau). Dilengkapi Stripe untuk langganan dan Customer Portal, autentikasi Google OAuth dengan PKCE, notifikasi email/SMS untuk ulasan negatif, serta dashboard metrik.",
